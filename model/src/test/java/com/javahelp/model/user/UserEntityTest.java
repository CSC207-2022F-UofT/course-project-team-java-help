...
public class UserEntityTest {
    ...
    public void testStringID(){
        // Not set this yet
        String stringID = "0NC31NABLUEM00N";
        assertNotEquals(stringID, user1.getStringID());

        // Until now
        user1.setStringID(stringID);
        assertEquals(stringID, user1.getStringID());
    }
