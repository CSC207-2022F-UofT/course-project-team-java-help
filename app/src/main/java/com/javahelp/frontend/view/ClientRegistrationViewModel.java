 ...
 */
public class ClientRegistrationViewModel extends AndroidViewModel implements IRegisterOutput {
    ...
    /**
     * Creates a new {@link ClientRegistrationViewModel}
     *
     * @param application {@link Application} to use
     */
    public ClientRegistrationViewModel(@NonNull Application application) {
        super(application);
    ...
    /**
     * Sets the lastname for this {@link ClientRegistrationViewModel}
     *
